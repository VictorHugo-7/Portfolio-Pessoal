        ...
        <div className="z-50 px-6 md:px-24 py-2.5 fixed w-full flex justify-between items-center bg-[var(--color-background)] border-b border-[var(--color-secondary)] text-[var(--color-primary)]">
            ...
            <div className="hidden md:flex gap-10 items-center">
                ...
                <button
                    ...
                    className="p-1 flex items-center gap-2 border-2 border-[var(--color-secondary)] rounded-md cursor-pointer hover:bg-[var(--color-secondary)]">
                    {isDark ? <Sun size={20} className="fill-[var(--color-primary)]" /> : <Moon size={20} className="fill-[var(--color-primary)]" />}
                    {isDark ? 'Claro' : 'Escuro'}
                </button>
            </div>
            ...
            <div className="md:hidden flex items-center gap-6">
                <button
                    onClick={toggleDarkMode}>
                    {isDark ? <Sun size={22} className="fill-[var(--color-primary)]" /> : <Moon size={22} className="fill-[var(--color-primary)]" />}
                </button>
                <button
                    onClick={toggleMenu}>
