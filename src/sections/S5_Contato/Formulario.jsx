...
function Formulario() {
    ...
    const manipularMudancaInput = (evento) => {
        ...
        setDadosFormulario(anterior => ({ ...anterior, [nome]: valor }));
    };
                ...
                <div className="rounded-md">
                    <div className="p-2 flex items-center border-[1.5px] border-[var(--color-secondary)] rounded-md">
                        ...
                        <input
                            ...
                            style={{ WebkitBoxShadow: "0 0 0 1000px transparent inset", WebkitTextFillColor: "var(--color-gray)", transition: "background-color 5000s ease-in-out 0s" }}
                            autoComplete="name"
                            required
                        />
                    </div>
